...
use Psys\SimpleOrderInvoice\Repository\FakturaOdberatelRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: FakturaOdberatelRepository::class)]
class FakturaOdberatel
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToOne(inversedBy: 'fakturaOdberatel', cascade: ['persist', 'remove'])]
    ...
    #[ORM\Column(length: 8, nullable: true, options:["fixed" => true])]
